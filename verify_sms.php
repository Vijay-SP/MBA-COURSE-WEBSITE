...
<body>
		...
		<div class="header-wrapper">
			...
			<div class="wsmobileheader clearfix">
				...
				<span class="smllogo smllogo-black"><img src="images/logo.png" width="120" height="50"
						alt="mobile-logo" /></span>
				<span class="smllogo smllogo-white"><img src="images/logo-white.png" width="120" height="50"
						alt="mobile-logo" /></span>
			</div>
			...
			<div class="wsmainfull menu clearfix">
				<div class="wsmainwp clearfix">
					...
					<div class="desktoplogo"><a href="#" class="logo-black"><img src="images/logo.png" width="160"
								height="60" alt="header-logo"></a></div>
					<div class="desktoplogo"><a href="#" class="logo-white"><img src="images/logo-white.png" width="160"
								height="60" alt="header-logo"></a></div>
	...
	<!-- END DROPDOWN MENU -->
<section id="hboxes-1" class="bg-whitesmoke wide-70 hero-boxes-section division text-center">
	<div class="col-md-5">
		...
		<div id="register-form">
			...
			<div id="input-name" class="col-md-12">
				<p>Enter OTP*</p><br>
				<input type="text" name="otp" class="form-control name" id="otp" placeholder="Please Enter The Otp Here"
					required>
			</div>
<br><br>
